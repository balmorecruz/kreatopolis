...
<head>
   ...
   <title>Videos que me gustan</title>
...
<section class="liked-videos">
   ...
   <h1 class="heading">Videos que te han gustado</h1>
   ...
   <div class="box">
      ...
      <form action="" method="post" class="flex-btn">
         ...
         <a href="watch_video.php?get_id=<?= $fetch_contents['id']; ?>" class="inline-btn">Ver</a>
         <input type="submit" value="Eliminar like" class="inline-delete-btn" name="remove">
      </form>
   </div>
   <?php
            }
