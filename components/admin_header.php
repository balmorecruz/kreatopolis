...
<div class="side-bar">
   ...
   <nav class="navbar">
      ...
      <a href="playlists.php"><i class="fa-solid fa-bars-staggered"></i><span>Cursos</span></a>
      ...
      <a href="../components/admin_logout.php" onclick="return confirm('logout from this website?');"><i class="fas fa-right-from-bracket"></i><span>Cerrar sesión</span></a>
   </nav>
