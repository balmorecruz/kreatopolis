...
<section class="quick-select">
   ...
   <div class="box-container">
      ...
      <div class="box">
         ...
         <p>Cursos destacados: <span><?= $total_bookmarked; ?></span></p>
      ...
      <div class="box">
         <h3 class="title">Categorías relevantes</h3>
         <div class="flex">
            <a href="search_course.php?"><i class="fas fa-code"></i><span>Desarrollo</span></a>
            <a href="#"><i class="fas fa-chart-simple"></i><span>Negocios</span></a>
            <a href="#"><i class="fas fa-pen"></i><span>Diseño</span></a>
            <a href="#"><i class="fas fa-chart-line"></i><span>Marketing</span></a>
            <a href="#"><i class="fas fa-music"></i><span>Música</span></a>
            <a href="#"><i class="fas fa-camera"></i><span>Fotografía</span></a>
      ...
      <div class="box tutor">
         <h3 class="title">Conviertete en tutor</h3>
         <p>Aplica en Kreatopolis y sé tu propio jefe, ofrezca clases privadas, imparta clases grupales y cree contenido pregrabado, ¡todo en su propio horario! </p>
         <a href="admin/register.php" class="inline-btn">Aplicar</a>
      </div>
