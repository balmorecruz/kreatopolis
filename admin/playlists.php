...
<section class="playlists">
   ...
   <h1 class="heading">Cursos creados</h1>

   <div class="box-container">
   
      <div class="box" style="text-align: center;">
         <h3 class="title" style="margin-bottom: .5rem;">Crear nuevo curso</h3>
         <a href="add_playlist.php" class="btn">Agregar curso</a>
      </div>
      ...
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Borrar" class="delete-btn" onclick="return confirm('delete this playlist?');" name="delete">
         </form>
         <a href="view_playlist.php?get_id=<?= $playlist_id; ?>" class="btn">Ver curso</a>
      </div>
      <?php
         } 
      }else{
