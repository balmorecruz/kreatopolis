...
<section class="playlist-form">
   ...
   <h1 class="heading">Crear curso</h1>

   <form action="" method="post" enctype="multipart/form-data">
      <p>Estado del curso <span>*</span></p>
      <select name="status" class="box" required>
         <option value="" selected disabled>-- seleccionar estado</option>
         <option value="active">Activo</option>
         <option value="deactive">Inactivo</option>
      </select>
      <p>Título del curso <span>*</span></p>
      ...
      <p>Miniatura <span>*</span></p>
      <input type="file" name="image" accept="image/*" required class="box">
      <input type="submit" value="Crear curso" name="submit" class="btn">
   </form>
