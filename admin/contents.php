...
<section class="contents">
   ...
   <h1 class="heading">Tus videos</h1>

   <div class="box-container">

   <div class="box" style="text-align: center;">
      <h3 class="title" style="margin-bottom: .5rem;">Crear nuevo video</h3>
      <a href="add_content.php" class="btn">Agregar video</a>
   </div>
   ...
   ?>
      <div class="box">
         ...
         <form action="" method="post" class="flex-btn">
            ...
            <input type="submit" value="Borrar" class="delete-btn" onclick="return confirm('delete this video?');" name="delete_video">
         </form>
   ...
   <?php
         ...
         echo '<p class="empty">Sin videos</p>';
      }
   ?>
